...
/**
 * Sample implementation of ClientUserDetailsService
 * 
...
public final static Logger LOG = LoggerFactory.getLogger(ClientUserDetailsServiceImpl.class);
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(multiOp.getSingleResult() != null) {
			...
			System.out.println("@@ Set Session Provider with logged in user "+clientUser.getLoginId());
			sessionProvider.setLoggedInUser(clientUser);
			return new ClientUserDetailsImpl(clientUser);
		} 
	...
	public ClientUserDetails getClientUserDetails() {
		...
		if (petclinic_user != null ) {
			return new ClientUserDetailsImpl(petclinic_user);
		} else
			return null;
	}
}
